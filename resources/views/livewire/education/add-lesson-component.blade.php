                        ...
                        <section>
                            <div class="card">
                                <div class="card-header">
                                    افزودن ویدیو جدید به بخش {{ $heading->title }}
                                </div>
                                <div class="card-body shadow-lg" style="background-color: #3f9fff">
                                    <form wire:submit.prevent="submit">
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">عنوان ویدیو</h6>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">توضیحات ویدیو</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">ویدیو</h6>
                                            </div>

                                            <div class="col-sm-9">
                                                <input type="file" wire:model="video">
                                                <div wire:loading wire:target="video">...در حال بارگذاری</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="submit" class="btn btn-success px-4" value="ثبت اطلاعات ">
                                            </div>
                                        </div>
                                        @if($errors->any())
                                            <div class="row mt-3">
